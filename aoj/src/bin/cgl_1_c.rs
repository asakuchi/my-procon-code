fn main() {
    ...
    for _ in 0..q {
        ...
        match Point2::counter_clockwise(p0, p1, p2) {
            CCW_PATTERN::COUNTER_CLOCKWISE => println!("COUNTER_CLOCKWISE"),
            CCW_PATTERN::CLOCKWISE => println!("CLOCKWISE"),
            CCW_PATTERN::ONLINE_BACK => println!("ONLINE_BACK"),
            CCW_PATTERN::ONLINE_FRONT => println!("ONLINE_FRONT"),
            CCW_PATTERN::ON_SEGMENT => println!("ON_SEGMENT"),
        }
    }
}
...
impl Segment2 {
    ...
    /// 線分と点pの距離
    fn distance_from(&self, p: Point2) -> f64 {
        // 場合分けが必要
